...
import { PIPELINE_CORE, VISUAL_TEAM, STORY_TEAM } from './agent-sets.js';

applyOrangeTheme();

export { PIPELINE_CORE, VISUAL_TEAM, STORY_TEAM };
...
export async function runInstallPrompts(detectedEngines) {
  ...
  const answers = await inquirer.prompt([
    ...
    },
    {
      ...
      choices: [
        ...
        { name: `Story Team ${chalk.gray('(cinema-deck, premise-forge, concept-storyteller, story-architect, design-audience-journey, direct-slide-sequence, direct-scene, direct-cinematic-motion, scene-brief, asset-scout, cine-animator)')}`, value: 'story', checked: true, disabled: 'sempre instalado' },
  ...
  const agents = [...PIPELINE_CORE, ...STORY_TEAM];
