  ...
  const answers = await inquirer.prompt([
    ...
    },
    {
      ...
      choices: [
        ...
        { name: `Story Team ${chalk.gray('(premise-forge, concept-storyteller, story-architect, design-audience-journey, direct-slide-sequence, direct-scene, direct-cinematic-motion)')}`, value: 'story', checked: false },
      ],
      loop: false,
    },
    {
