...
export async function runInstallPrompts(detectedEngines) {
  ...
  const answers = await inquirer.prompt([
    ...
    },
    {
      ...
      choices: [
        ...
        { name: `Story Team ${chalk.gray('(cinema-deck, premise-forge, concept-storyteller, story-architect, design-audience-journey, direct-slide-sequence, direct-scene, direct-cinematic-motion)')}`, value: 'story', checked: false },
      ],
      loop: false,
    },
    {
  ...
  if ((answers.teams ?? []).includes('story')) agents.push(...STORY_TEAM);
