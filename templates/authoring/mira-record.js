...
(function () {
    ...
    function injectCss() {
        ...
        st.textContent = [
            ...
            /* contagem regressiva antes de gravar (fora do video: so aparece antes do pipeline iniciar) */
    ...
    /* ---------- contagem regressiva 3-2-1 ----------
       Roda DEPOIS de a captura estar de pe e ANTES de o pipeline comecar a
       consumir frames: a contagem aparece para voce, mas nao entra no video.
       Portado do mira-record-16x9.js, identico. */
    ...
    async function start() {
        ...
        try {
            ...
            if (ui.mic.checked) {
                try { S.mic = paraStereo(await navigator.mediaDevices.getUserMedia({ audio: MIC_CONSTRAINTS, video: false })); }
