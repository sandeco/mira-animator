...
function animatedFragment(format) {
  ...
  if (format === 'mira') {
    ...
    // O palco tem que vir completo (.anim-stage + id no <svg>), como o contrato
    // prescreve: o fixture frouxo era o que deixava BUG-20260731-AMOM invisível.
    html = '<section data-layout="split"><div class="split-top"><h2>Dois fluxos</h2><!-- @MIRA:SIZE 3/10 --><div class="anim-stage" id="corrida-stage"><svg id="corrida-svg" viewBox="0 0 960 960"></svg></div></div><div class="cam-area"></div></section>';
  } else if (format === 'mira-studio-full') {
    html = '<section data-layout="thirds"><div class="thirds-main"><h2>Dois fluxos</h2><!-- @MIRA:SIZE 3/10 --><div class="anim-stage" id="corrida-stage"><svg id="corrida-svg" viewBox="0 0 1280 720"></svg></div></div><div class="cam-area"></div></section>';
  } else {
